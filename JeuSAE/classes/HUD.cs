...
public class Hud
{
    ...
    {
        var NouvelleLargeur = nombrePv / Constantes.VIE_JOUEUR * LargeurBarVieMax;
    ...
    public static void AjouteExp(double nombreExp)
    {
        ...
        {
            var NouvelleLargeur = nombreExp / 100d * LargeurBarExpMax;
    ...
    public static void AjouteElimination(int nombreEliminations)
    {
        ...
        {
            var NouvelleLargeur = nombreEliminations / 100d * LargeurBarEliminationsMax;
    ...
    {
        var NombreDiamantDansLabel = int.Parse(MainWindow.labDiamant.Content.ToString());
